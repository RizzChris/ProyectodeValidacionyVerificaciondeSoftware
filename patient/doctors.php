                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search" class="input-text header-searchbar" placeholder="Buscar nombre o correo del Doctor" list="doctors">&nbsp;&nbsp;
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <h2>¿Redirigir a las sesiones del Doctor?</h2>
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
                        ...
                        <input type="submit"  value="Sí" class="btn-primary btn"   >
