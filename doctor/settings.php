                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        ...
                                        <div>
                                                ...
                                                <div class="h3-dashboard"  style="font-size: 15px;">
                                                    Eliminará Permanentemente su Cuenta
                                                </div>
                                        </div>
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        ID del Doctor : '.$id.' (Generado Automáticamente)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="nic" class="input-text" placeholder="Número NIC" value="'.$nic.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Elegir especialidades: (Actual: '.$spcil_name.')</label>
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a class="close" href="settings.php">&times;</a>
                            <div class="content">
                                Si cambió su email, por favor cierre sesión e inicie sesión nuevamente con su nuevo email
