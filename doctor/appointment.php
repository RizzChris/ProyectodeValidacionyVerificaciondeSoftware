        ...
        if($action=='add-session'){
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <input type="submit" value="Programar esta Sesión" class="login-btn btn-primary btn" name="shedulesubmit">
                                </td>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            Desea eliminar este registro<br><br>
                            Nombre del Paciente: &nbsp;<b>'.substr($nameget,0,40).'</b><br>
                            Número de Cita &nbsp; : <b>'.substr($apponum,0,40).'</b><br><br>

                        </div>
                        <div style="display: flex;justify-content: center;">
                        <a href="delete-appointment.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Sí&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
